...
export const StaggeredDashboard: React.FC<StaggeredMenuProps> = ({
  ...
  const buildOpenTimeline = useCallback(() => {
    ...
    if (itemEls.length) gsap.set(itemEls, { yPercent: 140, rotate: 0 });
    if (numberEls.length)
            ...
            >
              {items && items.length ? (
                    ...
                    {it.isButton ? (
                      <button
                        ...
                        style={{
                          ...
                          boxShadow: `0 0 30px #B3005E`,
                          border: `2px solid ${THEME.colors.primary}`,
                        }}
                        onMouseEnter={(e) => {
                          e.currentTarget.style.boxShadow = `0 0 50px #00D9FF, 0 0 70px #B3005E`;
                          e.currentTarget.style.transform = "scale(1)";
                        }}
                        onMouseLeave={(e) => {
                          e.currentTarget.style.boxShadow = `0 0 30px #B3005E`;
                          e.currentTarget.style.transform = "scale(1)";
                        }}
                      >
                ...
                <li
                  ...
                  aria-hidden="true"
                >
                  <span className="sm-panel-item relative text-black font-semibold text-[2rem] cursor-pointer leading-none tracking-[-2px] uppercase transition-[background,color] duration-150 ease-linear inline-block no-underline pr-[1.4em]">
                    <span className="sm-panel-itemLabel inline-block [transform-origin:50%_100%] will-change-transform">
                      No items
                    </span>
                  </span>
